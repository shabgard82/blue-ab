    ...
    <>
      ...
      {transactionList.length ? (
        transactionList.map((item) => {
          return (
            <Stack pt={2} pl={2} pr={2} display="flex" direction="row" justifyContent='space-between' alignItems='center'>
              <Stack>
              ...
              <Stack sx={{fontSize:'18px'}}><mark style={{backgroundColor:"#c0cfcd",color:"black"}}>{item.amount} $</mark></Stack>
            </Stack>
          );
        })
      ) : (
